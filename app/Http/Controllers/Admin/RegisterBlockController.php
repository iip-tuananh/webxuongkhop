...
use App\Model\Admin\RegisterBlock as ThisModel;
...
class RegisterBlockController extends Controller
{
    protected $view = 'admin.register_block';
    protected $route = 'registerBlock';
