...
class ReviewController extends Controller
{
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->addColumn('content', function ($object) {
                if($object->type == 'text')  return e(Str::limit($object->message, 120, '...'));;
                return '<a href="'.$object->youtube.'" target="_blank">'.$object->youtube.'</a>';
            })
			...
			->addIndexColumn()
			->rawColumns(['name','image', 'content', 'action'])
			->make(true);
    }
	...
	public function store(Request $request)
	{
		$validate = Validator::make(
			...
			[
                ...
                'youtube' => 'required_if:type,video',
                'message'    => 'required_if:type,text',
                'image'      => 'required_if:type,text|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
		...
		try {
            ...
            if ($request->image && $request->type == 'text') {
