...
use App\Model\Admin\TreatmentStep as ThisModel;
...
{
    protected $view = 'admin.treatment_steps';
    protected $route = 'treatmentSteps';
    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ->editColumn('title', function ($object) {
                return '<a href = "'.route('treatmentSteps.edit',$object->id).'" title = "Xem chi tiết">'.$object->title.'</a>';
            })
    ...
    public function store(Request $request)
    {
        $rules = [
//            'cate_id' => 'required',
            'title' => 'required|unique:treatment_steps,title',
            'content' => 'nullable',
    ...
    {
        $rules = [
            'title' => 'required|unique:treatment_steps,title,'.$id,
            'content' => 'nullable',
            'step' => 'required|numeric',
