...
{
    protected $view = 'admin.knowledge_category';
    protected $route = 'knowledgeCategory';

    public function index()
    {
        $categories = ThisModel::query()->where('type', PostCategory::TYPE_KIENTHUC)
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $object->type = PostCategory::TYPE_KIENTHUC;
