    ...
    public function searchData(Request $request)
    {
        ...
        return Datatables::of($objects)
            ...
            ->addColumn('image', function ($object) {
                return '<img style ="max-width:100px !important" class="thumbnail img-preview" src="'.($object->image ? $object->image->path : '').'">';
            })
            ...
            ->addIndexColumn()
            ->rawColumns(['image','name','link','action'])
            ->make(true);
    }
    ...
    public function store(Request $request)
    {
        $validate = Validator::make(
            ...
            [
                ...
                'image' => 'nullable|file|mimes:jpg,jpeg,png,svg|max:3000',
