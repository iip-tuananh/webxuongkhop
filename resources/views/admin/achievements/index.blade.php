...
<div ng-cloak>
    <div class="row" ng-controller="Banners">
        ...
        {{-- Form tạo mới --}}
        @include('admin.achievements.create')
...
@section('script')
@include('admin.achievements.Achievement')
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '/admin/achievements/searchData',
    ...
    app.controller('Banners', function ($rootScope, $scope, $http) {
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/achievements/" + $scope.data.id + "/getDataForEdit",
                headers: {
