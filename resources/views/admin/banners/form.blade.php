        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group custom-group">
                    <label class="form-label required-label">Loại banner</label>
                    <select class="form-control" ng-model="form.type">
                        <option value="desktop" ng-selected="form.type == 'desktop'">Desktop</option>
                        <option value="mobile"  ng-selected="form.type == 'mobile'">Mobile</option>
                    </select>
...
{{--            </div>--}}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group custom-group ">
                    ...
                    <input class="form-control " type="text" ng-model="form.sort">
                    <span class="invalid-feedback d-block" role="alert">
                        <strong><% errors.sort[0] %></strong>
                    </span>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group custom-group">
                    <label class="form-label">Đường link liên kết</label>
