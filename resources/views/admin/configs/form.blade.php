		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
                ...
                <div class="form-group custom-group">
                    ...
                    <input class="form-control" ng-model="form.work_hours" type="text">
                </div>
...
{{--                    <textarea id="my-textarea" ck-editor class="form-control" ng-model="form.introduction" rows="3"></textarea>--}}
{{--                    <span class="invalid-feedback d-block" role="alert">--}}
...
{{--                </div>--}}
				...
				<div class="form-group custom-group">
					...
					<textarea id="my-textarea" ck-editor class="form-control" ng-model="form.web_des" rows="3"></textarea>
					<span class="invalid-feedback d-block" role="alert">
