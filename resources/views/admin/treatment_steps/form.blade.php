...
{{--        </div>--}}
        ...
        <div class="form-group custom-group mb-4">
            ...
            <textarea id="my-textarea" class="form-control" rows="5" ng-model="form.content"></textarea>
            <span class="invalid-feedback d-block" role="alert">
                <strong>
        ...
        <div class="form-group custom-group mb-4">
            ...
            <input class="form-control " type="number" ng-model="form.step">
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.step[0] %>
                </strong>
...
<div class="text-right">
    ...
    <a href="{{ route('treatmentSteps.index') }}" class="btn btn-danger btn-cons">
