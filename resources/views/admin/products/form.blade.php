...
<div class="row">
    <div class="col-sm-8">
        ...
        <div class="form-group custom-group mb-4">
            <label class="form-label required-label">Mã sản phẩm</label>
        ...
        <div class="form-group custom-group mb-4">
            ...
            <textarea class="form-control"  rows="5" ng-model="form.intro"></textarea>
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.intro[0] %>
                </strong>
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group custom-group mb-4">
            ...
            <input class="form-control " type="number" ng-model="form.count_sale">
            <span class="invalid-feedback d-block" role="alert">
                <strong>
                    <% errors.count_sale[0] %>
                </strong>
