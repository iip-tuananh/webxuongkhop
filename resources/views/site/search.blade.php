...
@section('content')
    ...
    <div class="inner-header-section-area"
         style="background-image: url(/site/img/all-images/bg/bg9.png); background-position: center;
          background-repeat: no-repeat; background-size: cover">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="hero-header">
                        <h1 class="text-anime-style-1">Tìm kiếm sản phẩm</h1>
                        <div class="space28"></div>
                        <a href="#" class="bradecrumb">
                            Có {{ $products->count() }} kết quả phù hợp với từ khóa "{{ $keyWord }}"</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--===== SERVICE AREA STARTS =======-->
    <div class="service-inner-area sp8" ng-controller="ProductCategory">
        <div class="container">
            <div class="row">
